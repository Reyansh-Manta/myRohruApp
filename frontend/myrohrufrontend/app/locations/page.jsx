...
export default function LocationsPage() {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const response = await axios.get(`${process.env.NEXT_PUBLIC_BACKEND}/api/v1/posts/category/must-visit-locations?sortBy=${sort}`,
                ...
                <div className={styles.main}>
                    ...
                    <div className={styles.mainright}>
                        <div className={styles.cp}>
                            <p className={styles.p1}>Travel</p>
                            <p className={styles.p2}>Locations!</p>
                        </div>
                            ...
                            {posts.map((post) => (
                                ...
                                <div className={styles.container} key={post.id}>
                                    <div style={{display: "flex", justifyContent: "center", alignItems: "center"}} className={styles.incont}>
                                        <img style={{ width: "inherit"}} src={post.image || "/placeholder.png"} alt="" />
                                    </div>
