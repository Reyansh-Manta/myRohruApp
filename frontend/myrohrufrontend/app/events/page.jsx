...
export default function EventsPage() {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const response = await axios.get(`${process.env.NEXT_PUBLIC_BACKEND}/api/v1/posts/category/events?sortBy=${sort}`,
                ...
                <div className={styles.main}>
                    ...
                    <div className={styles.mainright}>
                        <div className={styles.cp}>
                            <p className={styles.p1}>Eve</p>
                            <p className={styles.p2}>nts!</p>
                        </div>
